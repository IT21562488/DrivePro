    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference.child(firebaseAuth.currentUser!!.uid).addValueEventListener(object :
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                binding.etdriver.text = user.UserName
                binding.etVehicleCount.text = user.VehicleCount
        ...
        binding.btnUpdate.setOnClickListener {
            intent = Intent(applicationContext, DriverProfileUpdateActivity::class.java).also {
                ...
                it.putExtra("vcount" , user.VehicleCount)
                startActivity(it)
            }
        ...
        binding.imWallet.setOnClickListener {

            intent = Intent(applicationContext, DriverWallet::class.java)
